...
--14. Find sine, cosine and tangent of 3.1415.
	...
	SELECT SIN(3.1415),COS(3.14),TAN(3.1415)
...
--2. Display your name in lower & upper case.
	...
	SELECT UPPER('meet'),LOWER('MEET')

--3. Display first three characters of your name.
	
	SELECT SUBSTRING('MEETVAGHELA',1,3)

--4. Display 3rd to 10th character of your name.
	
	SELECT SUBSTRING('MEETVAGHELA',3,10)

--5. Write a query to convert ‘abc123efg’ to ‘abcXYZefg’ & ‘abcabcabc’ to ‘ab5ab5ab5’ using REPLACE.
	
	SELECT REPLACE('abc123efg',123,'XYZ')
	SELECT REPLACE('abcabcabc','b','5')
...
--7. Write a query to display character based on number 97, 65,122,90,48,57.
	...
	SELECT CHAR(97),CHAR(65),CHAR(122),CHAR(48),CHAR(57);
...
--17. Display FIRSTNAME and LASTNAME in lowercase and uppercase.
	...
	SELECT LOWER(FIRSTNAME),UPPER(FIRSTNAME) FROM EMPLOYEE
	SELECT LOWER(LASTNAME),UPPER(LASTNAME) FROM EMPLOYEE
