...
(
	...
	DEPARTMENTID INT NULL, FOREIGN KEY(DEPARTMENTID) REFERENCES DEPARTMENT (DEPARTMENTID),
...
VALUES
	...
	HOME_STADIUM_ID INT NULL, FOREIGN KEY(HOME_STADIUM_ID) REFERENCES STADIUM(STADIUM_ID),
	);
	...
	TEAM_ID INT NULL FOREIGN KEY(TEAM_ID) REFERENCES TEAM(TEAM_ID),
