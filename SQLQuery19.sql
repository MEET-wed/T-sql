...
-- 1.  Display all unique customer names from ONLINE_CUSTOMER and OFFLINE_CUSTOMER. 
    ...
    SELECT NAME,CITY FROM ONLINE_CUSTOMER
    UNION
    SELECT NAME,CITY FROM OFFLINE_CUSTOMER
...
-- 4.  Display unique customer IDs from both tables. 
    ...
    SELECT CID,NAME,CITY FROM ONLINE_CUSTOMER
    UNION ALL
    SELECT CID,NAME,CITY FROM OFFLINE_CUSTOMER
...
-- 8.  Display all customer IDs from CUSTOMER and OFFLINE_CUSTOMER using UNION ALL.
    ...
    SELECT CID,NAME,CITY FROM CUSTOMER
    UNION ALL
    SELECT CID,NAME,CITY FROM OFFLINE_CUSTOMER 
