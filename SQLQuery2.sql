...
--5. Give Student Name, City and SPI of student whose SPI is greater than 6.50.
	...
	SELECT  STDID,SNAME,CITY,SPI FROM STUDENT
	WHERE SPI>6.50
...
--18. Retrieve first five student IDs from STUDENT table.
	...
	SELECT TOP 5  SNAME,STDID FROM STUDENT
	WHERE BRANCH NOT IN ('COMPUTER')
	...
	SELECT * FROM STUDENT
	WHERE SPI > 7.0 AND SPI <= 9.0 OR STDID > 105 AND STDID < 109
